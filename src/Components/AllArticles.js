...
<<<<<<< HEAD
	...
	return (
		<>
			<h1 className="mt-10 text-center text-4xl font-extrabold text-gray-900">{articles[0].categoryID.name}</h1>
			<div className="custom-margin grid grid-cols-2 gap-4 my-16 ">
				{articles.map((article) => {
					return (
						<div className="container flex flex-col shadow-2xl py-8 px-16">
							<div>
								<h2 onClick={() => handleClick(article._id)} className="title-font hover:bg-green-200">
									{article.title}
								</h2>
							</div>
