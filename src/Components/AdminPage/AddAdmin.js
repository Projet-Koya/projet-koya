			...
			<div className="container ">
				...
				<div className="left-margin">
					<form className="flex flex-col ml-8" onSubmit={handleSubmit(onSubmit)}>
						...
						<input
							className="w-1/5 rounded-full py-3 px-6 bg-green-200"
							type="text"
							{...register("lastName", {
								required: true,
								onChange: (e) => setLastNameNewUser(e.target.value),
							})}
						></input>
						...
						<input
							className="w-1/5 rounded-full py-3 px-6 bg-green-200"
							type="text"
							{...register("name", { required: true, onChange: (e) => setNameNewUser(e.target.value) })}
						></input>
						...
						<input
							...
							{...register("confirmPassword", {
								required: true,
								onChange: (e) =>
									e.target.value === BufferPassword ? setPasswordNewUser(e.target.value) : null,
							})}
						></input>
						...
						<input
							className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 border border-blue-700 rounded w-28 rounded-full py-3 px-6 mt-2 ml-2"
							type="submit"
							value="Create"
						></input>
					</form>
