						...
						<div className="bg-green-50 rounded">
							<div className="shadow-md rounded-lg">
								<div className="p-4">
									...
									/>
									<button
										className="bg-primary my-3 text-black font-bold uppercase text-xs px-4 py-2 rounded shadow hover:shadow-md outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150"
										type="button"
